...
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        <div class="row">
            <div class="col-sm-5 col-3">
                <nav aria-label="breadcrumb">
                    <h4 class="">INNER CATEGORY CREATE</h4>
                    <ol class="breadcrumb">
        ...
        <hr/>
        <form id="categoryForm" action="{{ route('admin.inner-category.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                @if($errors->has('image'))
                    <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="show_main_menu" data-toggle="toggle" data-onstyle="danger" data-offstyle="warning">
                            </div>
                        </div>
