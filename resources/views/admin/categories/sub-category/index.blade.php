...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('admin.sub-category.create') }}" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Create Sub Category</a>
    </div>
</div>
<form method="get">
    <div class="row filter-row">
        ...
        <div class="col-sm-6 col-md-2">
            <a href="{{ route('admin.sub-category.index') }}" class="btn btn-secondary btn-block"> Reset </a>
        </div>
    </div>
</form>
<div class="row">
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('admin.sub-category.edit', $item->id) }}"><i class="fa fa-edit m-r-5"></i>Edit</a>
                                    ...
                                    @include('admin.__pertials.delete-form', ['actionUrl' => route('admin.sub-category.destroy', $item->id), 'formId' => 'deleteForm'.$item->id])
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr class="text-center">
                            <td colspan="5"><h5 class="empMsg">NO SUB CATEGORY FOUND!</h5></td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
