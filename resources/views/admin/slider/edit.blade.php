...
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        ...
        <hr/>
        <form id="sliderForm" action="{{ route('admin.slider.update', $data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                @if($errors->has('image'))
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Title</label>
                                <input name="title" class="form-control" value="{{ $data->title }}" type="text">
                                @if($errors->has('title'))
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="button_name" class="form-control" value="{{ $data->button_name }}" type="text">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="button_url" class="form-control" value="{{ $data->button_url }}" type="text">
