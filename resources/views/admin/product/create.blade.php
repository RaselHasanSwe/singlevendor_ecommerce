            ...
            <div class="col-sm-4 col-3">
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.category.index') }}">Product</a></li>
...
<script>
    ...
    function generateVariatioon()
    {
        ...
        for(let i = 0; i < totalColor; i++){
            for(let j = 0; j < totalSize; j++){
                appendAbleHtml += variationHtml(colors[i], sizes[j], colorsId[i], sizesId[j]);
            }
        }
    ...
    function variationHtml(color, size, colorId, sizeId)
    {
        let htmlItem = `
            <div class="row variation-div">
                ...
                <div class="col-sm-3">
                    <div class="form-group variationPd">
                        <input name="variation_price[]" class="form-control" placeholder="Eneter Price" value="" type="number">
                    </div>
                </div>
                <div class="col-sm-1">
                    <div class="form-group variationPd">
    ...
    $(document).on('submit', '#productForm', function(){
        ...
        if ($("input[name='main_image']").val() == '') {
            toastr.error("Please Enter Product Thumbnail Image");
            return false;
        }
