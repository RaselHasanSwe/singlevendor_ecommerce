...
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        ...
        <hr/>
        <form id="couponForm" action="{{ route('admin.coupon.update', $data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="coupon_name" class="form-control" value="{{ $data->name }}" type="text" required>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="coupon_code" class="form-control" value="{{ $data->code }}" type="text" required>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="minimum_amount_to_buy" class="form-control" value="{{ $data->min_amount_buy }}" type="text" required>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="amount" class="form-control" value="{{ $data->amount }}" type="number" required>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="coupon_description" id="exampleFormControlTextarea1" rows="3">{{ $data->description }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
