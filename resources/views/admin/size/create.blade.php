...
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        ...
        <hr/>
        <form id="sizeForm" action="{{ route('admin.size.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="measurement" class="form-control" value="" type="text" required>
